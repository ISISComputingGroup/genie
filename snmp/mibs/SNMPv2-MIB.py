#
# PySNMP MIB module SNMPv2-MIB (https://www.pysnmp.com/pysmi)
# ASN.1 source https://mibs.pysnmp.com/asn1/SNMPv2-MIB
...
Counter64, Gauge32, Counter32, Unsigned32, TimeTicks, ModuleIdentity, snmpModules, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, iso, mib_2, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Counter32", "Unsigned32", "TimeTicks", "ModuleIdentity", "snmpModules", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "mib-2", "Bits", "Integer32")
...
mibBuilder.exportSymbols("SNMPv2-MIB", sysLocation=sysLocation, sysORIndex=sysORIndex, snmpOutPkts=snmpOutPkts, snmpTrapEnterprise=snmpTrapEnterprise, warmStart=warmStart, snmpGroup=snmpGroup, snmpInGetRequests=snmpInGetRequests, snmpBasicComplianceRev2=snmpBasicComplianceRev2, system=system, snmpInASNParseErrs=snmpInASNParseErrs, systemGroup=systemGroup, snmpInBadVersions=snmpInBadVersions, sysOREntry=sysOREntry, snmpOutGetRequests=snmpOutGetRequests, sysORUpTime=sysORUpTime, snmpMIBGroups=snmpMIBGroups, snmpOutSetRequests=snmpOutSetRequests, snmpInSetRequests=snmpInSetRequests, snmpProxyDrops=snmpProxyDrops, sysORTable=sysORTable, snmpTrapOID=snmpTrapOID, coldStart=coldStart, snmpInBadValues=snmpInBadValues, snmpInTotalSetVars=snmpInTotalSetVars, snmpMIBObjects=snmpMIBObjects, snmpOutGetNexts=snmpOutGetNexts, snmpMIBCompliances=snmpMIBCompliances, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpInNoSuchNames=snmpInNoSuchNames, snmpBasicCompliance=snmpBasicCompliance, snmpMIB=snmpMIB, sysName=sysName, authenticationFailure=authenticationFailure, snmpNotificationGroup=snmpNotificationGroup, PYSNMP_MODULE_ID=snmpMIB, sysServices=sysServices, sysORDescr=sysORDescr, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpInGetResponses=snmpInGetResponses, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpTraps=snmpTraps, sysUpTime=sysUpTime, snmpOutGetResponses=snmpOutGetResponses, snmpOutTraps=snmpOutTraps, snmpCommunityGroup=snmpCommunityGroup, snmpOutBadValues=snmpOutBadValues, sysObjectID=sysObjectID, snmpTrap=snmpTrap, sysDescr=sysDescr, snmpSetSerialNo=snmpSetSerialNo, sysORLastChange=sysORLastChange, snmpInTooBigs=snmpInTooBigs, snmpSetGroup=snmpSetGroup, snmpInPkts=snmpInPkts, snmpInReadOnlys=snmpInReadOnlys, snmpInGetNexts=snmpInGetNexts, snmpOutGenErrs=snmpOutGenErrs, snmpInTraps=snmpInTraps, snmpSilentDrops=snmpSilentDrops, snmpOutTooBigs=snmpOutTooBigs, snmp=snmp, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpMIBConformance=snmpMIBConformance, snmpInGenErrs=snmpInGenErrs, sysORID=sysORID, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpInTotalReqVars=snmpInTotalReqVars, snmpObsoleteGroup=snmpObsoleteGroup, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpSet=snmpSet, sysContact=sysContact)
