...
# Produced by pysmi-1.1.13 at Tue Jan  2 16:03:40 2024
...
Counter64, Gauge32, Counter32, Unsigned32, TimeTicks, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, iso, mib_2, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Counter32", "Unsigned32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "mib-2", "Bits", "Integer32")
TimeStamp, PhysAddress, DisplayString, AutonomousType, RowStatus, TruthValue, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "PhysAddress", "DisplayString", "AutonomousType", "RowStatus", "TruthValue", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifStackLowerLayer=ifStackLowerLayer, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifLastChange=ifLastChange, ifPacketGroup=ifPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifOutQLen=ifOutQLen, ifConnectorPresent=ifConnectorPresent, ifMIBObjects=ifMIBObjects, linkUp=linkUp, ifTestId=ifTestId, ifStackGroup=ifStackGroup, ifAlias=ifAlias, ifInUnknownProtos=ifInUnknownProtos, ifOutDiscards=ifOutDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressType=ifRcvAddressType, ifGeneralGroup=ifGeneralGroup, ifTestEntry=ifTestEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifIndex=ifIndex, ifStackLastChange=ifStackLastChange, ifInDiscards=ifInDiscards, ifHCOutUcastPkts=ifHCOutUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTestResult=ifTestResult, ifOutNUcastPkts=ifOutNUcastPkts, ifTestStatus=ifTestStatus, ifXTable=ifXTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutOctets=ifOutOctets, ifName=ifName, ifEntry=ifEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTableLastChange=ifTableLastChange, ifCompliances=ifCompliances, ifTestTable=ifTestTable, interfaces=interfaces, InterfaceIndex=InterfaceIndex, ifStackGroup2=ifStackGroup2, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, ifHCOutOctets=ifHCOutOctets, ifConformance=ifConformance, ifOperStatus=ifOperStatus, ifNumber=ifNumber, ifRcvAddressEntry=ifRcvAddressEntry, ifInNUcastPkts=ifInNUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifInOctets=ifInOctets, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, ifAdminStatus=ifAdminStatus, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance3=ifCompliance3, ifSpeed=ifSpeed, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOldObjectsGroup=ifOldObjectsGroup, ifTestGroup=ifTestGroup, ifTable=ifTable, ifStackStatus=ifStackStatus, ifMtu=ifMtu, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, ifSpecific=ifSpecific, ifTestCode=ifTestCode, linkDown=linkDown, ifDescr=ifDescr, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPhysAddress=ifPhysAddress, ifOutMulticastPkts=ifOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifType=ifType, ifCompliance=ifCompliance, ifStackTable=ifStackTable, OwnerString=OwnerString, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInUcastPkts=ifHCInUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackEntry=ifStackEntry, ifRcvAddressAddress=ifRcvAddressAddress)
