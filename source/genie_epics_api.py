...
class API(object):
    ...
    def get_pv_from_block(self, name):
        """Get the PV name that the block points at"""
        pass
    ...
    def get_block_value(self, name, to_string=False):
        """Gets the current value for the block"""
        return self.get_pv_value(self.correct_blockname(name), to_string)
