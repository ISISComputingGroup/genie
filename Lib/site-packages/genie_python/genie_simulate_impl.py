...
class Waitfor(object):
    ...
    def start_waiting(self, block=None, value=None, lowlimit=None, highlimit=None, maxwait=None, wait_all=None,
        ...
        wait_str = ['{}={}'.format(arg, val) for arg, val in locals().items() if val is not None and arg != "self"]
...
class Dae(object):
    ...
    def end_run(self, *args, **kwargs):
        ...
        """
        if self.run_state == "RUNNING" or self.run_state == "PAUSED" or self.run_state == "ENDING":
            self.run_state = "SETUP"
        else:
    ...
    def pause_run(self, immediate=False):
        ...
        """
        if self.run_state == "RUNNING" or self.run_state == "PAUSING":
...
class API(object):
    ...
    def block_exists(self, name):
        ...
        return name in self.block_dict.keys()
