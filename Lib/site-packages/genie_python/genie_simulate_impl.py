...
class Dae(object):
    ...
    def set_period(self, period):
        ...
        if period <= self.num_periods:
            ...
            raise Exception(
                "Cannot set period as it is higher than the number of periods"
            )
    ...
    def configure_internal_periods(
        ...
        if output_delay is not None:
            if isinstance(output_delay, int):
                ...
                raise Exception(
                    "Output delay of periods must be an integer (microseconds)"
                )
    ...
    def change_tcb(self, low, high, step, trange, log=False, regime=1):
        ...
        if log:
            ...
            print(
                "Setting TCB range", low, "to", high, "step", step, "(LINEAR binning)"
            )
    ...
    def set_fermi_veto(self, enable=None, delay=1.0, width=1.0):
        ...
        if enable:
            ...
            print(
                "SET_FERMI_VETO: requested status is ON, delay:", delay, "width:", width
            )
        else:
...
class API(object):
    ...
    def get_block_data(self, block, fail_fast=False):
        ...
        ans["runcontrol"], ans["lowlimit"], ans[
            "highlimit"
        ] = self.get_runcontrol_settings(block)
