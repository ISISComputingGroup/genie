...
@log_command_and_handle_exception
def wait_for_pv(pv: str, value: Any, maxwait: int | None = None) -> None:
    """
...
@usercommand
@helparglist('')
def open_plot_window(is_primary: bool = True, host: Any | None = None, figures: Any | None = None) -> None:
    """
...
@helparglist('verbose')
@log_command_and_handle_exception
def set_dae_message_verbosity(verbose) -> None:
    """
...
@helparglist('')
@log_command_and_handle_exception
def get_exp_data(rb: int | str = '%', user: str = '%', role: str = '%', verbose: bool = False):
    """
