...
def prompt_to_set_script_dir(base_script_dir):
    ...
    Notes:
      ...
      is recommended to add to the init file:
        ...
        def init(inst):
            ...
            print(f"To set where scripts and data are save used set_dir(). Currently in {g.get_script_dir()}")
    ...
    while script_dir_not_set:
        ...
        try:
            ...
            print(f"Scripts will be run from and scans data is saved to {final_path}")
            script_dir_not_set = False
        except OSError as err:
            print(f"Directory does not exist and could not be created. {final_path}. Error: {err}")
