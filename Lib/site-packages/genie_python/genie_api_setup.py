...
def log_command_and_handle_exception(_func_name_unlikely_to_be_reused, *args, **kwargs):
    ...
    try:
        ...
        __api.logger.log_command(_func_name_unlikely_to_be_reused.__name__, log_args, time_taken=time_taken)
        if command_exception is not None:
            __api.logger.log_error_msg(f'An exception has occurred as a result of the command:\n{command_exception}')
