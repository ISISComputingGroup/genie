...
def set_user_script_dir(*directory):
    ...
    if base_name == '':
        raise OSError(f"Script dir does not exist and can not be created: {requested_dir}")
...
def log_command_and_handle_exception(_func_name_unlikely_to_be_reused, *args, **kwargs):
    ...
    if len(arg_names) >= len(args):
        ...
        log_args["args"] = args
    __api.log_command(_func_name_unlikely_to_be_reused.__name__, log_args)
    try:
        return _func_name_unlikely_to_be_reused(*args, **kwargs)
