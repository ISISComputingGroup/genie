...
class P4PWrapper(object):
    ...
    @staticmethod
    def set_pv_value(
        name: str, value: PVValue, wait: bool, timeout: int = TIMEOUT, safe_not_quick: bool = True
    ) -> None:
        if safe_not_quick:
    ...
    def add_monitor(
        ...
        context = P4PWrapper.get_context()
        subscription = context.monitor(
            name, _process_call_back, notify_disconnect=link_alarm_on_disconnect
        )
