...
class WaitForControllerState(object, metaclass=ABCMeta):
    ...
    def __init__(self, api: any, last_notification_time: any,
                 last_exception: any, context: any=None) -> None:
        """
...
class WaitForController(object):
    ...
    def wait_for_runstate(self, state: any, maxwaitsecs: int=3600,
                          onexit: bool=False, quiet: bool=False) -> None:
        """
    ...
    def _init_wait_time(self, seconds: int, minutes: int, hours: int,
