...
SECONDS_UNTIL_RENOTIFICATION_OF_EXCEPTION = 5 * 60
...
class WaitForControllerState:
    ...
    def start(api):
        ...
        :return: The state the context starts at.
        """
        return WaitForControllerConnectedState(api, datetime.now(), None)
...
class WaitForControllerExceptionState(WaitForControllerState):
    ...
    def handle_exception_notification(self, exception):
        ...
        if seconds_since_last_notification >= SECONDS_UNTIL_RENOTIFICATION_OF_EXCEPTION \
    ...
    def print_exception(self, exception):
        ...
        print(message)
        self._api.log_info_msg(message)

    def enter(self):
        """
        Do nothing upon entering this state.
        :return: None
        """
...
class WaitForControllerExceptionContext(object):
    ...
    def __init__(self, api):
        ...
        """
        self._state = WaitForControllerState.start(api)
        ...
        while True:
            ...
            try:
                ...
                if num % 2 == 0:
                    ...
                    context.process_exception(ValueError("asdknf"))
                num += 1
