...
class WaitForControllerState(object, metaclass=ABCMeta):
    ...
    def __init__(self, api: any, last_notification_time: any, last_exception: any, context: any=None) -> None: 
        """
    ...
    @staticmethod
    def _transition(new_state: any) -> any:
        """
    ...
    @staticmethod
    def start(api, context=None) -> any:
        """
        ...
        :return: The state the context starts at.
        """
        return WaitForControllerConnectedState(api: any, datetime.now(), context: any)

    @abstractmethod
    def handle_exception_notification(self, exception: Exception) -> None:
        """
    ...
    @abstractmethod
    def exception_cleared(self) -> None:
        """
...
class WaitForControllerExceptionState(WaitForControllerState):
    ...
    def handle_exception_notification(self, exception: Exception):
        """
    ...
    def exception_cleared(self) -> any:
        """
...
class WaitForControllerConnectedState(WaitForControllerState):
    ...
    def handle_exception_notification(self, exception: Exception) -> any:
        """
...
class WaitForControllerExceptionContext(object):
    ...
    def process_exception(self, exception: Exception) -> None:
        """
...
class WaitForController(object):
    ...
    def _print_if_not_quiet(self, text: any, quiet: bool) -> None:
        if not quiet:
            print(text)

    def wait_for_runstate(self, state: any, maxwaitsecs: int=3600, onexit: bool=False, quiet: bool=False) -> None:
        """
    ...
    def _init_wait_time(self, seconds: int, minutes: int, hours: int, quiet: bool=False, timeout_msg: str="") -> None:
    ...
    def _init_wait_block(self, block: any, value: any, lowlimit: any, highlimit: any,
                         quiet: bool=False, timeout_msg: str="") -> None:
        self.block = block
    ...
    def _get_block_limits(self, value: any, lowlimit: any, highlimit: any) -> any:
        low = None
        high = None
        ...
        if low is not None and high is not None and low > high:
            ...
            print(
                ...
                swapped to lowlimit({}) and highlimit({})".format(
                    low, high
                )
            )
        return low, high
