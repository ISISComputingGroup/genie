...
class BlockNamesManager:
    ...
    def _add_monitor(self):
        ...
        with PV_NAME_LOCK:
            ...
            try:
                self._cancel_monitor_fn = CaChannelWrapper.add_monitor(self._pv_name, self._update_block_names,
                                                                       to_string=True)
                self._update_block_names(CaChannelWrapper.get_pv_value(self._pv_name, to_string=True), None, None)
