...
def print_instrument_scripts_path():
    """
    Print the current instrument scripts path.
    """
    print("\nInstrument scripts directory: {}".format(
        os.path.join("C:\\", "Instrument", "Settings", "config", socket.gethostname(), "Python", "inst")))
