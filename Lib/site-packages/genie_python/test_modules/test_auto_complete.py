...
import six
from genie import get_script_dir
...
class TestGenieAutoCompletePyConsole(unittest.TestCase):
    ...
    @parameterized.expand([
        (u'', os.path.join(get_script_dir(), "scripts.py"), u"scripts.py"),
        (u'sc', os.path.join(get_script_dir(), "scripts.py"), u"scripts.py"),
        (u'scripts.py', os.path.join(get_script_dir(), "scripts.py"), u"scripts.py"),
        ])
    @patch('glob.glob')
...
class TestGenieAutoCompletePyDev(unittest.TestCase):
    ...
    @parameterized.expand([
        (u'', os.path.join(get_script_dir(), "scripts.py"), u"load_script(\"scripts.py"),
        (u'sc', os.path.join(get_script_dir(), "scripts.py"), u"load_script(\"scripts.py"),
        (u'scripts.py', os.path.join(get_script_dir(), "scripts.py"), u"py"),
        ])
    @patch('glob.glob')
    def test_GIVEN_line_starts_load_script_with_non_absolute_path_THEN_return_contents_of_scripting_dir(self, search_path, filename_from_glob, expected_result, mock_glob):
        # Arrange
