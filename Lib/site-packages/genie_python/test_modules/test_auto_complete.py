...
from genie_python.genie_api_setup import LoadScriptCompleter, USER_SCRIPT_DIR
...
class TestGenieAutoCompletePyConsole(unittest.TestCase):
    ...
    @parameterized.expand([
        (u'', os.path.join(USER_SCRIPT_DIR, "scripts.py"), u"scripts.py"),
        (u'sc', os.path.join(USER_SCRIPT_DIR, "scripts.py"), u"scripts.py"),
        (u'scripts.py', os.path.join(USER_SCRIPT_DIR, "scripts.py"), u"scripts.py"),
        ])
    @patch('glob.glob')
    def test_GIVEN_line_starts_load_script_with_non_absolute_path_THEN_return_contents_of_scripting_dir(self, search_path, filename_from_glob, expected_result, mock_glob):
        ...
        # Assert
        mock_glob.assert_called_with("{}{}*".format(USER_SCRIPT_DIR,search_path))
        assert_that(result, is_(expected_completer))
    ...
    def test_GIVEN_line_with_load_script_with_quote_WHEN_auto_complete_THEN_show_matches_with_quote(self, mock_glob):
        # Arrange
        search_path = u''
        mock_glob.return_value = ["filename.py"]
...
class TestGenieAutoCompletePyDev(unittest.TestCase):
    ...
    @parameterized.expand([
        (u'', os.path.join(USER_SCRIPT_DIR, "scripts.py"), u"load_script(\"scripts.py"),
        (u'sc', os.path.join(USER_SCRIPT_DIR, "scripts.py"), u"load_script(\"scripts.py"),
        (u'scripts.py', os.path.join(USER_SCRIPT_DIR, "scripts.py"), u"py"),
        ])
    @patch('glob.glob')
    def test_GIVEN_line_starts_load_script_with_non_absolute_path_THEN_return_contents_of_scripting_dir(self, search_path, filename_from_glob, expected_result, mock_glob):
        # Arrange
    ...
    def test_GIVEN_line_starts_load_script_with_nothing_else_THEN_return_contents_of_scripting_dir_with_load_script(self, mock_glob):
        ...
        mock_glob.return_value = ["{}play.py".format(USER_SCRIPT_DIR)]
        ...
        # Assert
        mock_glob.assert_called_with("{}*".format(USER_SCRIPT_DIR))
        assert_that(result, is_(expected_completer))
