...
from genie_python.genie_experimental_data import GetExperimentData, SELECT_FOR_EXP_DETAILS, NotFoundError
...
class TestGetExperimentData(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ([1, 'a', '%'], [1, 'a', None], False, '%'),
        ([1, 'a', '%'], [1, None, None], True, 'User with name "a" was not found. Please make sure the title and'
                                               ' name are correct (e.g. "Dr John Smith").'),
        ([1, 'a', 'b'], [1, 'a', 'b'], False, '%'),
        ([1, 'a', 'b'], [1, 'a', None], True, 'Role "{role}" was not found. Existing roles: '),
        (['%', 'a', '%'], [None, 'a', None], False, '%'),
        (['%', 'a', '%'], [None, None, None], True, 'User with name "a" was not found. Please make sure the title and'
                                                    ' name are correct (e.g. "Dr John Smith").'),
        (['%', '%', 'b'], [None, None, 'b'], False, '%'),
        (['%', '%', 'b'], [None, None, None], True, 'Role "{role}" was not found. Existing roles: '),
    ])
    ...
    @parameterized.expand([
        (
                ...
                [
                    {'rb_number': '111', 'user': 'user_name_1', 'role': 'role_name_1',
                     'start_date': '2020-09-15 08:30:00',
                     'duration': 1},
                    {'rb_number': '212', 'user': 'user_name_2', 'role': 'role_name_1',
                     'start_date': '2020-12-08 08:30:00',
                     'duration': 1},
                    {'rb_number': '765', 'user': 'user_name_3', 'role': 'role_name_1',
                     'start_date': '2020-10-08 08:30:00',
                     'duration': 1},
                    {'rb_number': '765', 'user': 'user_name_4', 'role': 'role_name_2',
                     'start_date': '2020-10-08 08:30:00',
                     'duration': 1},
                    {'rb_number': '887', 'user': 'user_name_5', 'role': 'role_name_1',
                     'start_date': '2020-09-18 08:30:00',
                     'duration': 1},
                    {'rb_number': '887', 'user': 'user_name_6', 'role': 'role_name_2',
                     'start_date': '2020-09-18 08:30:00',
                     'duration': 1},
                    {'rb_number': '912', 'user': 'user_name_7', 'role': 'role_name_1',
                     'start_date': '2020-09-11 08:30:00',
                     'duration': 1},
                    {'rb_number': '912', 'user': 'user_name_8', 'role': 'role_name_2',
                     'start_date': '2020-09-11 08:30:00',
                     'duration': 1},
                ]
        ),
    ...
    @parameterized.expand([
        (
                [
                    {
                        'rb_number': '1', 'user': 'user_name_-', 'role': 'role_name_-',
                        'start_date': '2020-09-15 08:30:00',
                        'duration': 'duration_1'
                    },
                    {
