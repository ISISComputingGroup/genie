...
from hamcrest import assert_that, is_, only_contains, has_length, has_key
...
def create_block_names(get_pv_value_mock, blocks, instrument_prefix="Prefix", get_pv_value_side_effect=None):
    block_names = BlockNames()
    block_names_manager = BlockNamesManager(block_names, delay_before_retry_add_monitor=1)

    switch_prefix(get_pv_value_mock, block_names_manager, blocks, instrument_prefix,get_pv_value_side_effect)
    return block_names, block_names_manager


def switch_prefix(get_pv_value_mock, blocks_manager, blocks=None, instrument_prefix="Prefix", get_blocks_pv_value=None, get_pv_value_side_effect=None):
    """
...
class TestGenieAutoCompletePyConsole(unittest.TestCase):
    ...
    def test_GIVEN_pv_doesnt_exist_WHEN_setup_THEN_block_names_contains_no_blocks(self, add_monitor_mock, get_pv_value_mock):
        block_names, _ = create_block_names(get_pv_value_mock, ["hi"], get_pv_value_side_effect=UnableToConnectToPVException("block name", "errro"))
    ...
    def test_GIVEN_pv_contains_nothing_WHEN_setup_THEN_block_names_contains_no_blocks(self, add_monitor_mock, get_pv_value_mock):
        ...
        switch_prefix(get_pv_value_mock, block_names_manager, instrument_prefix="", get_blocks_pv_value="")
    ...
    def test_GIVEN_pv_contains_non_hex_WHEN_setup_THEN_block_names_contains_no_blocks(self, add_monitor_mock, get_pv_value_mock):
        block_names, block_names_manager = create_block_names(get_pv_value_mock, ["hi"])
        switch_prefix(get_pv_value_mock, block_names_manager, instrument_prefix="", get_blocks_pv_value="not hex")
    ...
    def test_GIVEN_pv_contains_non_json_WHEN_setup_THEN_block_names_contains_no_blocks(self, add_monitor_mock, get_pv_value_mock):
        ...
        switch_prefix(get_pv_value_mock, block_names_manager, instrument_prefix="", get_blocks_pv_value=get_blocks_pv_value)
    ...
    def test_GIVEN_request_invalid_block_WHEN_inspect_block_THEN_attribute_error_thrown(self, add_monitor_mock, get_pv_value_mock):
        block_names, _ = create_block_names(get_pv_value_mock, [])
    ...
    def test_GIVEN_block_is_keyword_WHEN_inspect_block_THEN_it_has_an_unscore_after_it_but_the_value_doesnt(self, add_monitor_mock, get_pv_value_mock):
    ...
    def test_GIVEN_no_blocks_and_requested_block_is_followed_by_underscores_WHEN_inspect_block_THEN_it_has_an_unscore_after_it_but_the_value_doesnt(self, add_monitor_mock, get_pv_value_mock):
        expected_block_name = "class"
        block_names, _ = create_block_names(get_pv_value_mock, [expected_block_name])
