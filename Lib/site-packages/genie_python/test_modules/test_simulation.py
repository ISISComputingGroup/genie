...
class TestSimulationSetup(unittest.TestCase):
    ...
    def test_GIVEN_existing_blocks_WHEN_simulate_with_populate_blocks_THEN_blocks_populated(self, block_names):
        ...
        with genie.sim.Simulate(True):
            ...
            self.assertEquals("TEST_BLOCK", test_block_data['name'])
            self.assertEquals("INITIAL_VALUE", test_block_data['value'])
...
class TestSimulationSequence(unittest.TestCase):
    ...
    def test_GIVEN_multiple_blocks_WHEN_cset_runcontrol_THEN_exception(self):
        ...
        with self.assertRaisesRegexp(Exception, 'Runcontrol and wait can only be changed for one block at a time'):
    ...
    def test_GIVEN_change_rb_WHEN_get_rb_THEN_values_match(self, rb):
        ...
        # Assert
        self.assertEquals(str(rb), genie.get_rb())
    ...
    def test_GIVEN_changed_user_WHEN_getting_user_THEN_values_match(self):
        ...
        # Assert
        self.assertEquals(users, genie.get_dashboard()['user'])
