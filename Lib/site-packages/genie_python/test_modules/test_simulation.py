...
class TestSimulationSequence(unittest.TestCase):
    def setUp(self):
        ...
        # Use the simulated gennie_python api as the genie_python api
        self.original_api = getattr(genie, "__api")
        setattr(genie, "__api", self.api)
        genie_python.genie_api_setup._exceptions_raised=True

    def tearDown(self):
        # put back original api
        setattr(genie, "__api", self.original_api)
    ...
    def test_GIVEN_preexisting_block_WHEN_updating_values_THEN_update_values_and_retain_non_specified_values(self):
        ...
        enabled, low, high = self.api.get_runcontrol_settings('block')

        # Assert
        self.assertEquals(2.5, low)
        self.assertEquals(3, high)
    ...
    def test_GIVEN_preexisting_block_WHEN_set_no_values_THEN_retain_original_values(self):
        ...
        # Assert
        self.assertEquals(1.5, low)
        self.assertEquals(6, high)
    ...
    def test_GIVEN_no_preexisting_blocks_WHEN_set_values_for_a_block_THEN_set_values(self):
        ...
        # Assert
        self.assertEquals(0.5, low)
        self.assertEquals(None, high)
        self.assertEquals(False, enabled)
