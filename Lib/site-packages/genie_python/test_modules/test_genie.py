...
class TestGenie(unittest.TestCase):
    ...
    def test_WHEN_unicode_literals_imported_before_THEN_load_script_does_not_add_u_at_start_of_script_name(self):
        # Arrange
        script = os.path.join(os.path.abspath(os.path.dirname(__file__)), "test_scripts", "valid.py")
        ...
        try:
            ...
            # Assert
            print(e.message)
            self.fail("Should have been able to load script, maybe a python 2/3 compatibility issue with unicode")
