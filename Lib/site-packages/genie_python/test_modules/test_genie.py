...
class TestGenie(unittest.TestCase):
    ...
    def test_WHEN_waitfor_given_maxwait_and_frames_not_reached_THEN_times_out(self):
        self._api_setup()
        maxwait = 5
        start_time = datetime.utcnow()
        self._run_waitfor(5000, maxwait)
        end_time = datetime.utcnow()
        self.assertAlmostEqual((end_time - start_time).total_seconds(), float(maxwait), places=1)
    ...
    def test_WHEN_pv_disconnected_and_reconnected_THEN_error_and_reconnection_printed(self):
        # Simulate waiting for either 5000 frames or 10 seconds
    ...
    def test_WHEN_pv_disconnected_THEN_error_printed_every_five_mins(self):
        # Simulate waiting for either 5000 frames or 11 minutes
    ...
    def test_WHEN_disconnect_then_pv_reconnected_for_1_min_THEN_nothing_printed(self):
        # Simulate waiting for either 5000 frames or 60 seconds
