...
class TestGenie(unittest.TestCase):
    ...
    @patch('genie_python.genie._genie_api.get_block_names')
    def test_WHEN_waitfor_is_given_a_valid_block_as_a_keyword_argument_THEN_no_exception_raised_and_waitfor_called(self,
                                                                                                                   block_names,
                                                                                                                   start_waiting):
...
class TestChangeScriptDir(unittest.TestCase):
    ...
    @patch('genie_python.utilities._correct_path_casing_existing')
    @patch("os.mkdir")
    def test_GIVEN_defaults_WHEN_change_dir_to_existing_dir_using_forward_slashes_THEN_path_is_as_set(self,
                                                                                                      make_dirs_mock,
                                                                                                      correct_casing):
    ...
    @patch('genie_python.utilities._correct_path_casing_existing')
    @patch("os.mkdir")
    def test_GIVEN_defaults_WHEN_change_dir_but_top_dir_does_not_exist_THEN_path_created(self, make_dirs_mock,
                                                                                         correct_casing):
    ...
    @patch('genie_python.utilities._correct_path_casing_existing')
    @patch("os.mkdir")
    def test_GIVEN_defaults_WHEN_change_dir_but_top_three_dirs_do_not_exist_THEN_path_created(self, make_dirs_mock,
                                                                                              correct_casing):
        ...
        assert_that(self.created_paths, contains_exactly(os.path.abspath(os.path.join(existing_dir, subdir)),
                                                         ...
                                                         os.path.abspath(
                                                             os.path.join(existing_dir, subdir, subdir1, subdir2))))
        assert_that(result, is_(expected_dir))

    @patch('genie_python.utilities._correct_path_casing_existing')
    @patch("os.mkdir")
    def test_GIVEN_defaults_WHEN_change_dir_but_root_dir_does_not_exist_THEN_script_dir_not_changed(self,
                                                                                                    make_dirs_mock,
                                                                                                    correct_casing):
        self.setup_mocks(r"c:/scripts", correct_casing, make_dirs_mock)
