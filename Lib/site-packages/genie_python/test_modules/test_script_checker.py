...
class _CreateTempScriptAndReturnErrors():
    ...
    def __init__(self, script_checker, script, warnings_as_error=True, no_pyright=False):
        self.temp_script_file = write_to_file(script)
        self.warnings_as_error=warnings_as_error
        self.no_pyright=no_pyright
        self.script_checker = script_checker

    def __enter__(self):
        return self.script_checker.checker.check_script(self.temp_script_file.name, self.script_checker.machine, warnings_as_error=self.warnings_as_error, no_pyright=self.no_pyright)
...
class TestScriptChecker(unittest.TestCase):
    ...
    def test_GIVEN_end_without_brackets_WHEN_check_THEN_error_message(self):
        ...
        with _CreateTempScriptAndReturnErrors(self, script_lines) as errors:
    ...
    def test_GIVEN_end_as_end_of_another_word_WHEN_check_THEN_no_error_message(self):
        ...
        with _CreateTempScriptAndReturnErrors(self, script_lines, no_pyright=True) as errors:
            self.assertEqual(errors, [])
    ...
    def test_GIVEN_invalid_range_THEN_pyright_throws_exception(self):
        ...
        expected = "On line 2:23 - Argument of type"
    ...
    def test_GIVEN_invalid_var_type_THEN_pyright_throws_exception(self):
        ...
        expected = "On line 2:5 - Expression of type"
    ...
    def test_GIVEN_invalid_genie_script_WHEN_pyright_script_checker_called_THEN_pyright_throws_exception(self):
        ...
        expected = "On line 3:16 - Argument of type"
