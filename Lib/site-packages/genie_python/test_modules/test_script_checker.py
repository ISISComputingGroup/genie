...
class TestScriptChecker(unittest.TestCase):
    ...
    def test_GIVEN_end_without_brackets_WHEN_check_THEN_error_message(self):
        ...
        self.assertEqual(result[0], "W:  4: Statement seems to have no effect (pointless-statement)")
    ...
    def test_GIVEN_end_without_brackets_at_start_of_line_WHEN_check_THEN_error_message(self):
        ...
        self.assertEqual(result[0], "W:  3: Statement seems to have no effect (pointless-statement)")
    ...
    def test_GIVEN_end_without_brackets_on_line_with_fn_with_brackets_WHEN_check_THEN_error_message(self):
        ...
        self.assertEqual(result[0], "W:  2: Statement seems to have no effect (pointless-statement)")
    ...
    def test_GIVEN_function_with_g_WHEN_check_THEN_warn_user(self):
        ...
        self.assertEqual(result[0], "E:  3: Module 'genie_python.genie' has no 'test_function' member (no-member)")
    ...
    def test_GIVEN_g_non_existing_command_WHEN_call_THEN_error_message(self):
        ...
        os.unlink(temp_script_file.name)
        self.assertEqual(result[0], "E:  3: Module 'genie_python.genie' has no "
    ...
    def test_GIVEN_invalid_python_class_WHEN_call_check_THEN_error(self):
        ...
        result = self.checker.check_script(temp_script_file.name, self.machine)
        os.unlink(temp_script_file.name)
        expected = 'E:  1: Parsing failed: \'expected an indented block after class definition'
        self.assertTrue(result[0].startswith(expected),
                        f"Result was {result}, expected first line to start with {expected}")
