...
class TestScriptChecker(unittest.TestCase):
    ...
    def test_GIVEN_end_without_brackets_WHEN_check_THEN_error_message(self):
        ...
        result = self.checker.check_script(temp_script_file.name, self.machine, warnings_as_error=True)
    ...
    def test_GIVEN_end_as_start_of_another_word_WHEN_check_THEN_no_error_message(self):
        ...
        temp_script_file = write_to_file(script_lines)
        result = self.checker.check_script(temp_script_file.name, self.machine, no_pyright=True)
    ...
    def test_GIVEN_function_with_g_WHEN_check_THEN_warn_user(self):
        ...
        self.assertEqual(result, ["E:  3: Module 'genie_python.genie' has no 'test_function' member (no-member)"])
    ...
    def test_GIVEN_2_g_assignments_WHEN_check_THEN_warning_message(self):
        ...
        self.assertEqual(result, ["W:  3: 'g' assignment in line 3", "W:  4: 'g' assignment in line 4"])
    ...
    def test_GIVEN_g_non_existing_command_WHEN_call_THEN_error_message(self):
        ...
        os.unlink(temp_script_file.name)
        self.assertEqual(result, ["E:  3: Module 'genie_python.genie' has no "
    ...
    def test_GIVEN_invalid_range_THEN_pyright_throws_exception(self):
        ...
        errors = self.checker.check_script(temp_script_file.name, self.machine, warnings_as_error=True)
        print(errors)
    ...
    def test_GIVEN_invalid_var_type_THEN_pyright_throws_exception(self):
        ...
        #expected = "E:  1: Parsing failed: 'invalid decimal literal"
        temp_script_file = write_to_file(script_lines)
    ...
    def test_GIVEN_new_directory_WHEN_pyright_script_checker_called_THEN_pyright_json_created_then_destroyed_after_use(self):
        ...
        with self.checker.temporary_pyright_config(temp_dir, self.instrument) as config_man:
    ...
    # def test_GIVEN_invalid_general_dae_script_WHEN_pyright_script_checker_called_THEN_pyright_throws_exception(self):

    #     script_lines = ["from technique.sans.util import dae_setter\n",
    #                     "def test_dae():\n",
    #                     "   dae_setter(1,2,3,4,5,6,7,8,9)\n"]
    ...
    # def test_GIVEN_invalid_inst_script_WHEN_pyright_script_checker_called_THEN_pyright_throws_exception(self):

    #     script_lines = ["import inst",
    #                     "def test_inst():",
    #                     "   inst.sample_changer_scloop(1,2,3,4,5,6,7,8,9)"]       
            
    #     #expected = "E:  1: Parsing failed: 'invalid syntax"
    #     temp_script_file = write_to_file(script_lines)

    #     errors = self.checker.check_script(temp_script_file.name, self.machine, warnings_as_error=True, pyright_additional_include=["C:\\Instrument\\Settings\\config\\NDW2452\\Python\\inst"])
    #     #self.assertTrue(errors[0].startswith(expected))
    #     os.unlink(temp_script_file.name)
