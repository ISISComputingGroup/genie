...
class TestScriptChecker(unittest.TestCase):
    ...
    def test_GIVEN_new_directory_WHEN_pyright_script_checker_called_THEN_new_pyright_json_created(self):
        ...
        print("\n\n\n\n\n\n")
        print(temp_script_file.name)
        print("\n\n\n\n\n\n")

        self.checker.pyright_script_checker(temp_script_file.name)

        json_file = f"{temp_dir}\\pyrightconfig.json"
        self.assertTrue(os.path.exists(json_file))
        
        shutil.rmtree(temp_dir)


    # New test that mkdir and calls pyright_script_checker(self, [newdir]\[random_string]): and check that it creates a new pyright json
