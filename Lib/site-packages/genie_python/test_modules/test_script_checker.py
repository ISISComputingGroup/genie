...
class TestScriptChecker(unittest.TestCase):
    ...
    class _CreateTempScriptAndReturnErrors():
        ...
        def __init__(self, script_checker, script, warnings_as_error=True, no_pyright=False, dir=""):
            self.temp_script_file = write_to_file(script, dir=dir)
    ...
    def test_GIVEN_invalid_range_THEN_pyright_throws_exception(self):
        ...
        expected = "[PR] E: 2: Argument of type"
    ...
    def test_GIVEN_invalid_var_type_THEN_pyright_throws_exception(self):
        ...
        expected = "[PR] E: 2: Expression of type"
    ...
    def test_GIVEN_invalid_genie_script_WHEN_pyright_script_checker_called_THEN_pyright_throws_exception(self):
        ...
        expected = "[PR] E: 3: Argument of type"
