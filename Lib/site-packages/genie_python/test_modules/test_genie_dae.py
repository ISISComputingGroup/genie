...
DAE_SETTINGS_XML = """<Cluster>
    ...
    <String>
        ...
        <Val>C:/Instrument/Settings/config/NDW1801/configurations/tables/detector128.dat</Val>
    </String>
    <String>
        <Name>Spectra Table</Name>
        <Val>C:/Instrument/Settings/config/NDW1801/configurations/tables/spectra128.dat</Val>
    </String>
    <EW>
...
class TestGenieDAE(unittest.TestCase):
    ...
    def test_GIVEN_in_setup_state_and_period_pv_in_invalid_alarm_WHEN_set_period_called_THEN_exception_thrown(self):
        self.dae.api.get_pv_value = MagicMock(return_value="SETUP")
        self.dae.api.get_alarm_of_pv = MagicMock(return_value="INVALID")

        self.assertRaises(IOError, self.dae.set_period, -1)

    def test_GIVEN_in_setup_state_and_period_pv_no_alarm_WHEN_set_period_called_THEN_exception_thrown(self):
        self.dae.api.get_pv_value = MagicMock(return_value="SETUP")
