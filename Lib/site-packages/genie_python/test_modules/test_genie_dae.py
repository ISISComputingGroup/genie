...
class TestGenieDAE(unittest.TestCase):
    ...
    def test_GIVEN_instrument_in_setup_and_in_change_and_not_in_transition_WHEN_change_finish_called_THEN_no_exception_thrown_and_not_in_change(self):
        ...
        self.dae.api.get_pv_value = TestGenieDAE.get_mock_pv_value
    ...
    def test_GIVEN_in_ending_state_WHEN_end_run_called_THEN_no_exception_thrown(self):
        self.dae.api.get_pv_value = MagicMock(return_value="ENDING")

        self.dae.end_run()

    def test_GIVEN_in_pausing_state_WHEN_pause_run_called_THEN_no_exception_thrown(self):
        self.dae.api.get_pv_value = MagicMock(return_value="PAUSING")
    ...
    def test_WHEN_get_spectrum_integrate_for_whole_range_THEN_whole_integrated_range(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[0], X_RETURN[YC_NORD_RETURN])
    ...
    def test_WHEN_get_spectrum_integrate_for_unspecified_range_THEN_get_whole_range(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1)
    ...
    def test_WHEN_get_spectrum_integrate_for_one_count_THEN_get_just_that_count(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[1], X_RETURN[2])
    ...
    def test_WHEN_get_spectrum_integrate_for_count_partial_first_bin_top_limit_not_on_boundry_THEN_get_part_of_count(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[1], X_RETURN[1] + WIDTHS[1] * 0.25)
    ...
    def test_WHEN_get_spectrum_integrate_for_count_partial_first_bin_lower_limit_no_on_boundryTHEN_get_part_of_count(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[1] + WIDTHS[1] * 0.25, X_RETURN[2])
    ...
    def test_WHEN_get_spectrum_integrate_for_count_partial_of_two_different_bins_none_apart_THEN_get_part_of_count(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[1] + WIDTHS[1] * 0.25, X_RETURN[2] + WIDTHS[2] * 0.4)
    ...
    def test_WHEN_get_spectrum_integrate_for_count_partial_of_two_different_bins_one_apart_THEN_get_part_of_count(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[1] + WIDTHS[1] * 0.25, X_RETURN[3] + WIDTHS[3] * 0.4)
    ...
    def test_WHEN_get_spectrum_integrate_for_count_partial_of_one_bins_THEN_get_part_of_count(self):
        ...
        result = self.dae.get_spectrum_integral(1, 1, X_RETURN[1] + WIDTHS[1] * 0.25, X_RETURN[1] + WIDTHS[1] * 0.4)
    ...
    def test_WHEN_get_spectrum_integrate_and_low_limit_is_below_lowest_bin_THEN_error(self):
        ...
        assert_that(calling(self.dae.get_spectrum_integral).with_args(1, 1, X_RETURN[0] - 0.01, X_RETURN[1]),
                    raises(ValueError))
    ...
    def test_WHEN_get_spectrum_integrate_and_upper_limit_is_above_highest_bin_THEN_error(self):
        ...
        assert_that(calling(self.dae.get_spectrum_integral).with_args(1, 1, X_RETURN[0], X_RETURN[YC_NORD_RETURN] + 0.1),
                    raises(ValueError))
    ...
    def test_WHEN_get_spectrum_integrate_and_upper_limit_is_below_lower_limit_THEN_error(self):
        ...
        assert_that(calling(self.dae.get_spectrum_integral).with_args(1, 1, 10, 9),
                    raises(ValueError))
