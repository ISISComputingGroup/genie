...
class TestGenieDAE(unittest.TestCase):
    ...
    def test_GIVEN_instrument_in_setup_and_in_change_and_not_in_transition_WHEN_change_finish_called_THEN_no_exception_thrown_and_not_in_change_and_new_cache(self):
        self.dae.in_change = True
