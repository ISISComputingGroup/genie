...
class TestGenieAutoCompletePyConsole(unittest.TestCase):
    ...
    @parameterized.expand([
        (os.path.join('c:','scri'), "c:/scripts", u"scripts"),
        (os.path.join('c:','scripts'), "c:/scripts", u"scripts"),
        (os.path.join('c:','scripts'), "c:/scripts/play.com", u"scripts/play.com"),
        (os.path.join('c:','scripts','play.'), "c:/scripts/play.py", u"py"),
        (os.path.join('c:','scripts','play.p'), "c:/scripts/play.py", u"py"),
        (os.path.join('c:','scripts','play '), "c:/scripts/play - a.py", u"- a.py"),
        (os.path.join('c:','scripts','play -'), "c:/scripts/play - a.py", u" a.py")
        ])
    @patch('glob.glob')
    ...
    def test_GIVEN_line_with_load_script_with_no_matching_paths_WHEN_auto_complete_THEN_no_matches(self, mock_glob):
        # Arrange
        search_path = os.path.join('c:','scri')
...
class TestGenieAutoCompletePyDev(unittest.TestCase):
    ...
    @parameterized.expand([
        (os.path.join('c:','scripts','play.'), r"c:/scripts/play.py", "py"),
        (os.path.join('c:','scripts','play.p'), r"c:/scripts/play.py", "py"),
        (os.path.join('c:','scri'), r"c:/scripts", "scripts"),
        (os.path.join('c:','scripts'), r"c:/scripts", "scripts"),
        (os.path.join('c:','scri'), r"c:/scripts","scripts"),
        (os.path.join('c:','scripts','play '), os.path.join("c:","scripts","play - a.py"), "- a.py"),
        (os.path.join('c:','scripts','play -'), os.path.join("c:","scripts","play - a.py"), " a.py"),
        ])
    @patch('glob.glob')
