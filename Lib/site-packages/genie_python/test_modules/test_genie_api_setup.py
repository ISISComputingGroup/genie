...
class TestGenieAutoCompletePyConsole(unittest.TestCase):
    ...
    @parameterized.expand([
        (os.path.join(DRIVE_ROOT,'scri'), DRIVE_ROOT_PREFIX + "/scripts", u"scripts"),
        (os.path.join(DRIVE_ROOT,'scripts'), DRIVE_ROOT_PREFIX + "/scripts", u"scripts"),
        (os.path.join(DRIVE_ROOT,'scripts'), DRIVE_ROOT_PREFIX + "/scripts/play.com", u"scripts/play.com"),
        (os.path.join(DRIVE_ROOT,'scripts','play.'), DRIVE_ROOT_PREFIX + "/scripts/play.py", u"py"),
        (os.path.join(DRIVE_ROOT,'scripts','play.p'), DRIVE_ROOT_PREFIX + "/scripts/play.py", u"py"),
        (os.path.join(DRIVE_ROOT,'scripts','play '), DRIVE_ROOT_PREFIX + "/scripts/play - a.py", u"- a.py"),
        (os.path.join(DRIVE_ROOT,'scripts','play -'), DRIVE_ROOT_PREFIX + "/scripts/play - a.py", u" a.py")
        ])
    @patch('glob.glob')
    ...
    def test_GIVEN_line_with_load_script_with_quote_WHEN_auto_complete_THEN_show_matches_with_quote(self, mock_glob):
        # Arrange
        search_path = DRIVE_ROOT_PREFIX + u'/scripts/'
...
class TestGenieAutoCompletePyDev(unittest.TestCase):
    ...
    @parameterized.expand([
        (os.path.join(DRIVE_ROOT,'scripts','play.'), DRIVE_ROOT_PREFIX + r"/scripts/play.py", "py"),
        (os.path.join(DRIVE_ROOT,'scripts','play.p'), DRIVE_ROOT_PREFIX + r"/scripts/play.py", "py"),
...
class TestLogAndExceptionDecorator(unittest.TestCase):
    ...
    def test_GIVEN_decorated_method_WHEN_call_with_no_args_THEN_logs_name(self, logger):
        ...
        test_func()
        logger.assert_called_with("test_func", {'kwargs': {}, 'args': {}}, time_taken=0.0)
    ...
    def test_GIVEN_decorated_method_WHEN_call_with_named_args_THEN_logs_name_and_args(self, logger):
        ...
        test_func(1, 2, 3)
        logger.assert_called_with("test_func", {'kwargs': {}, 'args': {"arg_one": 1, "arg_two": 2, "arg_three": 3}}, time_taken=0.0)
    ...
    def test_GIVEN_decorated_method_WHEN_call_with_kwargs_THEN_logs_name_and_kwargs(self, logger):
        ...
        logger.assert_called_with("test_func", {'kwargs': {"kwarg_one": 1, "kwarg_two": 2}, 'args': {}}, time_taken=0.0)
    ...
    def test_GIVEN_decorated_method_WHEN_call_with_mixed_args_and_kwargs_THEN_logs_name_args_and_kwargs(self, logger):
        ...
        logger.assert_called_with("test_func", {'kwargs': {"kwarg_one": 1, "kwarg_two": 2}, 'args': {"arg_one": 1}}, time_taken=0.0)
    ...
    def test_GIVEN_decorated_method_WHEN_call_with_mixed_named_args_and_args_THEN_logs_args_without_name(self, logger):
        ...
        test_func(1, 2, 3)
        logger.assert_called_with("test_func", {'kwargs': {}, 'args': (1, 2, 3)}, time_taken=0.0)
