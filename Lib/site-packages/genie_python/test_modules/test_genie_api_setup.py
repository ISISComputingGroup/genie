...
class TestGenieAutoCompletePyConsole(unittest.TestCase):
    ...
    @parameterized.expand([
        (u'c:\scri', "c:/scripts", u"scripts"),
        (u'c:\scripts', "c:/scripts", u"scripts"),
        (u'c:\scripts', "c:/scripts/play.com", u"scripts/play.com"),
        (u'c:\scripts\play.', "c:/scripts/play.py", u"py"),
        (u'c:\scripts\play.p', "c:/scripts/play.py", u"py"),
        (u'c:\scripts\play ', "c:/scripts/play - a.py", u"- a.py"),
        (u'c:\scripts\play -', "c:/scripts/play - a.py", u" a.py")
        ])
    @patch('glob.glob')
