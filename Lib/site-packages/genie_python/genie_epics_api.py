...
class API(object):
    ...
    def _setup_logger(self):
        ...
        self.genie_logger.addHandler(handler)
    ...
    def log_info_msg(self, message):
        ...
        self.genie_logger.info(f"{message} CMD")
    ...
    def log_command(self, function_name, arguments):
        ...
        self.write_to_log(f"{function_name} {arguments}", "CMD")
        self.genie_logger.debug(f"{function_name} {arguments} CMD")

    def log_error_msg(self, error_msg):
        """Log the error to the log file"""
        self.genie_filter.exception_text = error_msg
        self.write_to_log(f"ERROR: {error_msg}", "CMD")
        self.genie_logger.error(f"ERROR: {error_msg} CMD")

    def log_ca_msg(self, error_msg):
        """Log the CA error (from CaChannel) to the log file"""
        self.genie_filter.exception_text = error_msg
        self.write_to_log(f"ERROR: {error_msg}", "CA")
        self.genie_logger.error(f"ERROR: {error_msg} CA")
