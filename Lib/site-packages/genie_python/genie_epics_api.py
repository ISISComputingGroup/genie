...
class API(object):
    def __init__(self, pv_prefix, globs, environment_details=None):
        ...
        self.machine_name = ""
        self.localmod = None
        self.log_dir = os.path.join("C:", os.sep, "Instrument", "Var", "logs", "genie_python")
        self.block_prefix = "CS:SB:"
        self.motion_suffix = "CS:MOT:MOVING"
        self.pre_post_cmd_manager = PrePostCmdManager()
        self.logger = GenieLogger(self.log_dir, self.instrument_name)
    ...
    def set_instrument(self, machine_identifier, globs, import_instrument_init=True):
        ...
        self.logger.filter.instrument = instrument
