...
try:
    ...
    smslib = MagicMock()
    warning_message = (
        "Sending alerts not supported in this version of genie_python, "
        "please contact ISIS Experiment Controls"
    )
...
class API(object):
    def __init__(
        self, pv_prefix: str, globs: dict, environment_details: EnvironmentDetails = None
    ) -> None:
        """
    ...
    def get_block_data(
        self, block: str, fail_fast: bool = False
    ) -> dict[str, PVValue, str, bool, bool, float, float, str]:
        """
