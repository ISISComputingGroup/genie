...
from genie_python.utilities import crc8, EnvironmentDetails, remove_field_from_pv as remove_field_from_pv_util
...
class API(object):
    ...
    def pv_exists(self, name, attempts=3):
        """
    ...
    def add_prefix(self, block):
        """
        Adds the prefixes to a block to get the underlying PV.
        """
        return self.__inst_prefix + API.__block_prefix + block.upper()
    ...
    def block_exists(self, name):
        ...
        """
        return self.pv_exists(self.add_prefix(name.upper()))
    ...
    def set_block_value(self, name, value=None, runcontrol=None, lowlimit=None, highlimit=None, wait=False):
        ...
        full_name = self.add_prefix(name)
        ...
        if runcontrol is not None:
            ...
            self.set_pv_value(full_name + ":RC:ENABLE", enable)
    ...
    def remove_field_from_pv(self, pv):
        ...
        """
        return remove_field_from_pv_util(pv)
    ...
    def get_pv_alarm(self, pv_name):
        ...
        """
        try:
            return self.get_pv_value("{}.SEVR".format(self.remove_field_from_pv(pv_name)), to_string=True)
        except Exception:
            return "UNKNOWN"
