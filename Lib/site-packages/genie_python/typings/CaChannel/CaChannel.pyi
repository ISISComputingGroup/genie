...
import sys
from typing import TypeAlias, Tuple, Callable, TypeVar, Any
...
class CaChannel:
    ...
    @classmethod
    @attach_ca_context
    def replace_printf_handler(cls, callback: Callable[[str, Tuple[T, ...]], None]=..., user_args:Tuple[T, ...]|None=...)-> None:
        """
    ...
    def add_masked_array_event(self, req_type, count, mask, callback, *user_args, **keywords): # -> None:
