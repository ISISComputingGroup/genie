...
class Dae(object):
    ...
    def _isis_dae_triggered_state_was_reached(self, trigger_pv, state, timeout_per_trigger=20,
        ...
        """
        Trigger a state and what for the state to be reached. For example stop the ISIS DAE and wait for it to be
    ...
    def _temporarily_kill_icp(self):
        ...
        try:
            ...
            if not self._isis_dae_triggered_state_was_reached("CS:PS:ISISDAE_01:STOP", "Running"):
