...
class Dae(object):
    ...
    def __init__(self, api, prefix=""):
        ...
        self.verbose = False
        self._wait_for_completion_callback_dae_settings = True #this is the default value to ensure daesettings are written before returning, only changed for testing
    ...
    def _change_dae_settings(self):
        ...
        if changed:
            self._set_pv_value(self._get_dae_pv_name("daesettings_sp"), ET.tostring(root), wait=self._wait_for_completion_callback_dae_settings)
