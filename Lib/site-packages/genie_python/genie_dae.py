...
class Dae(object):
    ...
    def end_run(self, verbose=False, quiet=False, immediate=False):
        ...
        if immediate:
            with open("C:\\data\\end_now.dae", "w+") as f:
                f.write(u"1")

        if self.get_run_state() == "ENDING" and not immediate:
            print("Please specify the 'immediate=True' flag to immediately end a run while in an ending state")
    ...
    def pause_run(self, immediate=False):
        ...
        if self.get_run_state() == "PAUSING" and not immediate:
            print("Please specify the 'immediate=True' flag to immediately pause a run while in an pausing state")
    ...
    def get_spectrum(self, spectrum, period=1, dist=True):
        """
