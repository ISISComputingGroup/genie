...
class Dae(object):
    ...
    def begin_run(self, period=None, meas_id=None, meas_type=None, meas_subid=None,
        ...
        try:
            self.api.logger.log_info_msg(f"Proposal number: {self.get_rb_number()} Team: {self.get_users()}")
        except Exception as e:
            self.api.logger.log_error_msg(f"Unable to read RB/Users from service: {e}")
