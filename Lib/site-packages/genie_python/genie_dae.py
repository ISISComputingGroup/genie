...
class Dae(object):
    ...
    def get_spectrum(self, spectrum, period=1, dist=True):
        ...
        Args:
            ...
            dist: whether to get as a distribution
        ...
        if dist:
            ...
            y_data = self._get_pv_value(self._get_dae_pv_name("getspectrum_yc") % (period, spectrum))
            y_size = self._get_pv_value(self._get_dae_pv_name("getspectrum_yc_size") % (period, spectrum))
            y_data = y_data[:y_size]
