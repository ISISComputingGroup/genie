        ...
        def _wrapper(self, *args, **kwargs):
            if not kwargs.pop("skip_required_runstates", False):
                ...
                if run_state not in set(runstates):
                    e_string = "{} can only be run in the following runstates: {}".format(func.func_name,
                                                                                          runstates_string)
...
class Dae(object):
    ...
    def set_period(self, period):
        ...
        if run_state == 'SETUP' or run_state == 'PAUSED':
            ...
            if self.api.get_alarm_of_pv(self._get_dae_pv_name("period_sp")) == "INVALID":
    ...
    def _change_period_settings(self):
        ...
        :raises: An IOError if the DAE could not set the number of periods.
        """
        ...
        if changed:
            ...
            if self.api.get_alarm_of_pv(self._get_dae_pv_name("periodsettings_sp")) == "INVALID":
                raise IOError("The DAE could not set the number of periods! This may be because you are trying to "
                              "set a number that is too large for the DAE memory. Try a lower number!")
