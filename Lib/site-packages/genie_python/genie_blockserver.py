...
from genie_python.utilities import compress_and_hex, waveform_to_string, dehex_decompress_and_dejson
import six
import time
    ...
    def wrapper(*args, **kwargs):
        while True:
            try:
                ...
                print("Exception thrown from {}: {}, will retry in 15 seconds".format(func.__name__,
...
class BlockServer(object):
    ...
    def get_block_names(self):
        ...
        raw = self._get_pv_value("{}{}".format(BLOCK_SERVER_PREFIX, PV_BLOCK_NAMES), True)
    ...
    def get_current_block_values(self):
        ...
        raw = self._get_pv_value(BLOCK_SERVER_PREFIX + "BLOCKVALUES", True)
        blks = dehex_decompress_and_dejson(raw)
