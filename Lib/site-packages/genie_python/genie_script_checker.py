...
class ScriptChecker(object):
    ...
    def check_script_lines(self, lines: list[str]) -> list[str]:
        """
    ...
    def check_script(
        ...
        pyright_additional_include: list[str] = None,
    ) -> list[str]:
        """
    ...
    def split_warning_errors(self, errors_outputs: list[str]) -> tuple[list[str], list[str]]:
        """
