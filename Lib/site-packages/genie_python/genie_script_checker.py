...
class ScriptChecker(object):
    ...
    def split_warning_errors(self, errors_outputs):
        ...
        verbose_warning = [str for str in errors_outputs if any(warning in str for warning in verbose_warning)]
                    ...
                    # getting class and its attributes
                        ...
                        for function_body in item.body:
                            if isinstance(function_body, ast.FunctionDef) and "__" not in function_body.name:
                                attributes += "{class_name}.{funciton_name},".\
                                    format(class_name=class_name, funciton_name=function_body.name)
                            else:
