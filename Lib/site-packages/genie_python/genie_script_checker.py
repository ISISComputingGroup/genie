...
def timeit(func):
    ...
    def _wrapper(*args, **kwargs):
        ...
        print("{} took {:.3f}s".format(func.__name__, end - start))
        return result
...
class ScriptChecker(object):
    ...
    def _can_cache_module(self, module_name, module):
        ...
        if module_name in sys.builtin_module_names:
            print("Caching {} as it is a builtin".format(module_name))
            return True
        ...
        if module.file is not None and any(
            ...
            print("Caching {} as it is a site module".format(module_name))
            return True

        # Other modules are probably user-defined e.g. inst scripts, shared scripts, user scripts. Don't cache these.
        print("Not caching {}".format(module_name))
        return False

    def _clear_astroid_cache(self):
        new_cache = {}
