...
class CaChannelWrapper(object):
    ...
    @staticmethod
    def set_pv_value(name: str, value: any, wait: bool = False, timeout: int = TIMEOUT,
    ...
    @staticmethod
    def clear_monitor(name: str, timeout: int = EXIST_TIMEOUT) -> None:
    ...
    @staticmethod
    def get_pv_timestamp(name: str, timeout: int = TIMEOUT) -> Tuple[int, int]:
        """
    ...
    @staticmethod
    def pv_exists(name: str, timeout: int = EXIST_TIMEOUT) -> bool:
        """
    ...
    @staticmethod
    def add_monitor(
        name: str, call_back_function: Callable[[any, any, any], None],
            link_alarm_on_disconnect: bool = True, to_string: bool = False,
            use_numpy: bool | None = None) -> Callable[[], None]:
        """
