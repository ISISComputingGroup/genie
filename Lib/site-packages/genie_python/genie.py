...
if sys.version_info != SUPPORTED_PYTHON_VERSION:
    message = "WARNING: genie_python only guarantees support for Python version {0[0]}.{0[1]}, you are running {1[0]}.{1[1]}"\
        .format(SUPPORTED_PYTHON_VERSION, sys.version_info)
