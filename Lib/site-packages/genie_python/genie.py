...
SUPPORTED_PYTHON_VERSION = (3, 11, 2)
...
def waitfor(block=None, value=None, lowlimit=None, highlimit=None, maxwait=None,
            ...
            frames=None, raw_frames=None, uamps=None, mevents=None, early_exit=lambda: False, quiet=False, **pars):
    """
...
@log_command_and_handle_exception
def waitfor_block(block, value=None, lowlimit=None, highlimit=None, maxwait=None, early_exit=lambda: False, quiet=False):
    """
...
@log_command_and_handle_exception
def waitfor_time(seconds=None, minutes=None, hours=None, time=None, quiet=False):
    """
...
@helparglist('frames')
@log_command_and_handle_exception
def waitfor_frames(frames, quiet=False):
    """
...
@log_command_and_handle_exception
def waitfor_raw_frames(raw_frames, quiet=False):
    """
...
@helparglist('uamps')
@log_command_and_handle_exception
def waitfor_uamps(uamps, quiet=False):
    """
...
@helparglist('mevents')
@log_command_and_handle_exception
def waitfor_mevents(mevents, quiet=False):
    """
...
def waitfor_runstate(state, maxwaitsecs=3600, onexit=False):
    ...
    _genie_api.waitfor.wait_for_runstate(state, maxwaitsecs, onexit)
...
@log_command_and_handle_exception
def connected_pvs_in_list(pv_list, is_local=False):
    """
...
@log_command_and_handle_exception
def set_display_title(display_title):
    """
