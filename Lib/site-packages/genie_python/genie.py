...
@helparglist('...')
@log_command_and_handle_exception
def cset(*args: Any, **kwargs: Any) -> None:
    """
...
@log_command_and_handle_exception
def waitfor(block: str | None = None, value: Any = None, lowlimit: float | None = None, highlimit: float | None = None, maxwait: float | None = None,
            wait_all: bool = False, seconds: float | None = None, minutes: float | None = None, hours: float | None = None, time: str | None = None,
            frames: int | None = None, raw_frames: int | None = None, uamps: float | None = None, mevents: float | None = None, early_exit: Callable[[], bool] = lambda: False,
            quiet: bool = False, **pars: Any) -> None:
    """
...
@log_command_and_handle_exception
def waitfor_block(block: str, value: Any = None, lowlimit: float | None = None, highlimit:
...
def waitfor_time(seconds: float | None = None, minutes: float | None = None, hours: float | None = None,
                 time: str | None = None, quiet: bool = False) -> None:
    """
...
@log_command_and_handle_exception
def waitfor_runstate(state: str, maxwaitsecs: int = 3600, onexit: bool = False, quiet: bool = False) -> None:
    """
...
@log_command_and_handle_exception
def get_pv(name: str, to_string: bool = False, is_local: bool = False, use_numpy: bool = False):
    """
...
@helparglist('...')
@log_command_and_handle_exception
def begin(period: int = 1, meas_id: str | None = None, meas_type: str = "", meas_subid: str = "",
          sample_id: str = "", delayed: bool = False, quiet: bool = False, paused: bool = False,
          verbose: bool = False, prepost: bool = True) -> None:
    """
...
@log_command_and_handle_exception
def end(verbose: bool = False, quiet: bool = False, immediate: bool = False, prepost: bool = False) -> None:
    """
    End the current run.
...
def change_tcb(low: float | None = None, high: float | None = None, step: float | None = None,
               trange: int = 1, log: bool = False, regime: int = 1) -> None:
    """
    Change the time channel boundaries.
...
def enable_hard_periods(mode: str, period_file: str | None = None, sequences: int | None = None, output_delay: int | None = None,
                        period: int | None = None, daq: bool = False, dwell: bool = False, unused: bool = False,
...
def configure_internal_periods(sequences: int | None = None, output_delay: int | None = None, period: int | None = None,
                               daq: bool = False, dwell: bool = False, unused: bool = False,
                               frames: int | None = None, output: int | None = None, label: str | None = None) -> None:
    """
...
@helparglist('[...]')
@log_command_and_handle_exception
def define_hard_period(period: int | None = None, daq: bool = False, dwell: bool = False, 
                       unused: bool = False, frames: int | None = None, output: int | None = None,
...
@log_command_and_handle_exception
def integrate_spectrum(spectrum:int, period: int = 1, t_min: float | None = None, t_max: float | None = None):
    """
...
@helparglist('mode')
@log_command_and_handle_exception
def set_dae_simulation_mode(mode: bool, skip_required_runstates: bool = False):
    """
