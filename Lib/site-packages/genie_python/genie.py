...
from genie_python.utilities import EnvironmentDetails, get_correct_path, \
    get_correct_filepath_existing, check_lowlimit_against_highlimit
from genie_python.genie_api_setup import __api as _genie_api
from genie_python.genie_api_setup import helparglist, usercommand, \
    set_user_script_dir, get_user_script_dir, log_command_and_handle_exception
...
import genie_python.genie_simulate as sim
import genie_python.genie_alerts as alerts
import genie_python.genie_toggle_settings as toggle
...
@helparglist('block')
@log_command_and_handle_exception
def get_block_units(block_name: str) -> str:
    """
...
@helparglist('...')
@log_command_and_handle_exception
def cset(*args: Any, **kwargs: bool | float) -> None:
    """
    ...
    for block, value in list(zip(blocks, values)):
        ...
        _genie_api.set_block_value(block, value, run_control, low_limit, high_limit, wait)
        _warn_if_block_alarm(block)

    # Display what the new block state is as a result of the command if cset verbosity is toggled on, or the command
    # was specifically called with 'verbose=True'. If default verbosity is True, but the command was specifically
...
def _print_from_cget(block_details: dict[str,str]) -> None:
    """
    Prints the values obtained through cget into a human readable format, used for cshow.

    Args:
        block_details (dict): dict containing information on the block (see return of cget)
    """
    format_string = '{name} = {value} (runcontrol = {runcontrol}, lowlimit = {lowlimit}, highlimit = {highlimit}, ' \
                    'alarm = {alarm})'
...
@log_command_and_handle_exception
def waitfor(block: str | None = None, value: float | None = None, lowlimit: float | None = None, highlimit: float | None = None, maxwait: float | None = None,
            wait_all: bool | None = False, seconds: float | None = None, minutes: float | None = None, hours: float | None = None, time: str | None = None,
            frames: int | None = None, raw_frames: int | None = None, uamps: float | None = None, mevents: float | None = None, early_exit=lambda: False,
            quiet: bool | None = False, **pars: Any) -> None:
    """
    ...
    _genie_api.waitfor.start_waiting(block, value, lowlimit, highlimit, maxwait, wait_all, seconds, minutes, hours,time, frames, raw_frames, uamps, mevents, early_exit, quiet)


@usercommand
@helparglist('block[, value][, lowlimit][, highlimit][, maxwait]')
@log_command_and_handle_exception
def waitfor_block(block: str, value = None, lowlimit: float | None = None, highlimit:
                  float | None = None, maxwait: float | None = None, early_exit: Callable[[],bool] = lambda: False,
                  quiet: bool | None = False) -> None:
    """
    ...
    # Warn if highlimit and lowlimit are round correct way
    check_lowlimit_against_highlimit(lowlimit, highlimit)
    _genie_api.waitfor.start_waiting(block=block, value=value, lowlimit=lowlimit, highlimit=highlimit, maxwait=maxwait,
                                     early_exit=early_exit, quiet=quiet)


@usercommand
@helparglist('[seconds][, minutes][, hours][, time]')
@log_command_and_handle_exception
def waitfor_time(seconds: float | None = None, minutes: float | None = None, hours: float | None = None,
                 time: str | None = None, quiet: bool | None = None) -> None:
    """
    ...
    _genie_api.waitfor.start_waiting(seconds=seconds, minutes=minutes, hours=hours, time=time, quiet=quiet)


@usercommand
@helparglist('frames')
@log_command_and_handle_exception
def waitfor_frames(frames: int, quiet: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def waitfor_raw_frames(raw_frames: int, quiet: bool | None = False) -> None:
    """
...
@helparglist('uamps')
@log_command_and_handle_exception
def waitfor_uamps(uamps: float, quiet: bool | None = False) -> None:
    """
...
@helparglist('mevents')
@log_command_and_handle_exception
def waitfor_mevents(mevents: float, quiet: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def waitfor_runstate(state: str, maxwaitsecs: int | None = 3600, onexit: bool | None = False, quiet: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def get_pv(name: str, to_string: bool | None = False, is_local: bool | None = False, use_numpy: bool | None = False):
    """
...
@log_command_and_handle_exception
def set_pv(name:str, value: Any, wait: bool | None = False, is_local: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def connected_pvs_in_list(pv_list: list[str], is_local: bool | None = False) -> list[str]:
    """
...
@helparglist('...')
@log_command_and_handle_exception
def begin(period: int | None = 1, meas_id: str | None = None, meas_type: str | None = "", meas_subid: str | None = "",
          sample_id: str | None = "", delayed: bool | None = False, quiet: bool | None = False, paused: bool | None = False,
          verbose: bool | None = False, prepost: bool | None = True) -> None:
    """
    ...
    if pre_post_cmd_return is None:
        _genie_api.dae.begin_run(period, meas_id, meas_type, meas_subid, sample_id, delayed, quiet, paused, prepost)

        waitfor_runstate("SETUP", onexit=True)

        _genie_api.dae.post_begin_check(verbose)
        _genie_api.pre_post_cmd_manager.begin_postcmd(run_num=_genie_api.dae.get_run_number(), quiet=quiet, prepost=prepost)
    else:
...
@log_command_and_handle_exception
def abort(verbose: bool | None = False, prepost: bool | None = True) -> None:
    """
...
@log_command_and_handle_exception
def end(verbose: bool | None = False, quiet: bool | None = False, immediate: bool | None = False, prepost: bool | None = False) -> None:
    """
    End the current run.
...
@log_command_and_handle_exception
def pause(verbose: bool | None = False, immediate: bool | None = False, prepost: bool | None = True) -> None:
    """
...
@helparglist('[verbose], [prepost]')
@log_command_and_handle_exception
def resume(verbose: bool | None = False, prepost: bool | None = False) -> None:
    """
...
@helparglist('[verbose]')
@log_command_and_handle_exception
def recover(verbose: bool | None = False) -> None:
    """
...
@helparglist('[verbose]')
@log_command_and_handle_exception
def updatestore(verbose: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def update(pause_run: bool | None = True, verbose: bool | None = False) -> None:
    """
...
@helparglist('[verbose]')
@log_command_and_handle_exception
def store(verbose: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def snapshot_crpt(filename: str | None = "c:\\Data\\snapshot_crpt.tmp", verbose: bool | None = False) -> None:
    """
...
@helparglist('[period]')
@log_command_and_handle_exception
def get_uamps(period: bool | None = False) -> float:
    """
...
@helparglist('[period]')
@log_command_and_handle_exception
def get_frames(period: bool | None = False) -> int:
    """
...
@helparglist('[period]')
@log_command_and_handle_exception
def get_raw_frames(period: bool | None = False) -> int:
    """
...
@helparglist('')
@log_command_and_handle_exception
def get_time_since_begin(get_timedelta: bool = False) -> int | datetime.timedelta:
    """
   ...
   Returns
       ...
       timedelta: the time since begin as a datetime.timedelta object (Year-Month-Day  Hour:Minute:Second)
...
def get_dashboard() -> _GetdashboardReturn:
    ...
    # data["dae_memory_used"] = genie_api.dae.get_memory_used()         #Not implemented in EPICS system
...
def __load_module(name: str, directory: str | list[str]) -> types.ModuleType:
    """
...
@log_command_and_handle_exception
def change_script_dir(*directory: str | list[str]) -> None:
    """
    Set the directory for loading user scripts from.

    Args:
        directory (string|List(string)): the directory to load user scripts from, either as a single entry or as
         multiple arguments
    Example:
...
@log_command_and_handle_exception
def change_tables(wiring: str | None = None, detector: str | None = None, spectra: str | None = None) -> None:
    """
    ...
    if wiring is not None:
        try:
            ...
            errors.append("Could not find wiring table. Did you type the file name correctly? %s" % wiring)
    if spectra is not None:
        try:
            spectra = get_table_file(spectra)
        except:
            errors.append("Could not find spectra table. Did you type the file name correctly? %s" % spectra)
    if detector is not None:
        try:
            detector = get_table_file(detector)
        except:
            errors.append("Could not find detector table. Did you type the file name correctly? %s" % detector)
...
@log_command_and_handle_exception
def change_tcb_file(tcbfile: str | None = None, default: bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def change_tcb(low: float | None = None, high: float | None = None, step: float | None = None,
               trange: int | None = 1, log: bool | None = False, regime: int | None = 1) -> None:
    """
    Change the time channel boundaries.
...
@log_command_and_handle_exception
def change_fermi_veto(enable: bool | None = None, delay: float | None = 1.0, width: float | None = 1.0) -> None:
    """
...
@helparglist('mode[, ...]')
@log_command_and_handle_exception
def enable_hard_periods(mode: str, period_file: str | None = None, sequences: int | None = None, output_delay: int | None = None,
                        period: int | None = None, daq: bool | None = False, dwell: bool | None = False, unused: bool | None = False,
                        frames: int | None = None, output: int | None = None, label: str | None = None) -> None:
    """
    ...
    """
    _genie_api.dae.configure_hard_periods(mode, period_file, sequences, output_delay, period, daq, dwell, unused, frames, output, label)


@usercommand
@helparglist('[...]')
@log_command_and_handle_exception
def configure_internal_periods(sequences: int | None = None, output_delay: int | None = None, period: int | None = None,
                               daq: bool | None = False, dwell: bool | None = False, unused: bool | None = False,
                               frames: int | None = None, output: int | None = None, label: str | None = None) -> None:
    """
    ...
    Note: if the period number is unspecified then the settings will be applied to all periods
    """
    _genie_api.dae.configure_internal_periods(sequences, output_delay, period, daq, dwell, unused, frames, output,label)

@usercommand
@helparglist('[...]')
@log_command_and_handle_exception
def define_hard_period(period: int | None = None, daq: bool | None = False, dwell: bool | None = False, 
                       unused: bool | None = False, frames: int | None = None, output: int | None = None,
...
@log_command_and_handle_exception
def change_number_soft_periods(number: int, enable:  bool | None = False) -> None:
    """
...
@log_command_and_handle_exception
def get_spectrum(spectrum:int, period: int | None = 1, dist: bool | None = True) -> _GetspectrumReturn:
    """
...
@helparglist('spectrum[, period][, dist]')
@log_command_and_handle_exception
def plot_spectrum(spectrum:int, period: int | None = 1, dist: bool | None = True) -> object:
    """
...
@log_command_and_handle_exception
def integrate_spectrum(spectrum:int, period: int | None = 1, t_min: float | None = None, t_max: float | None = None):
    """
...
class _GetsampleparsReturn(TypedDict):
    ...
    class _GetsampleparsReturn_MEAS(TypedDict):
        ID: int
        LABEL: str
        SUBID: int
        TYPE: int

    class _GetsampleparsReturn_SCRIPT(TypedDict):
        NAME: str
    ...
    HEIGHT: float
    ID: int
    MEAS: _GetsampleparsReturn_MEAS
    NAME: str
    PHI: float
    SCRIPT: _GetsampleparsReturn_SCRIPT
    TEMP_LABEL: str
    THICK: float
    TYPE: str
    WIDTH: float
...
@log_command_and_handle_exception
def change_sample_par(name: str, value: Any) -> None:
    """
...
@helparglist('name, value')
@log_command_and_handle_exception
def change_beamline_par(name: str, value: Any) -> None:
    """
...
@helparglist('mode')
@log_command_and_handle_exception
def set_dae_simulation_mode(mode: bool, skip_required_runstates: bool | None = False):
    """
    ...
    return _genie_api.dae.set_simulation_mode(mode, skip_required_runstates=skip_required_runstates)
