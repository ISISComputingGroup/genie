...
def change_tables(wiring=None, detector=None, spectra=None):
    ...
    try:
        ...
        if wiring is not None:
            paths_to_check["Wiring"] = get_correct_filepath_existing(wiring)
        if spectra is not None:
            paths_to_check["Spectra"] = get_correct_filepath_existing(spectra)
        if detector is not None:
            paths_to_check["Detector"] = get_correct_filepath_existing(detector)
