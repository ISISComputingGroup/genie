...
def waitfor(block=None, value=None, lowlimit=None, highlimit=None, maxwait=None,
    ...
    _genie_api.waitfor.start_waiting(block, value, lowlimit, highlimit, maxwait, wait_all, seconds, minutes, hours,time, frames, raw_frames, uamps, mevents, early_exit)
