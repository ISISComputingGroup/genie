...
@usercommand
@helparglist('mode')
def set_dae_simulation_mode(mode, force=False):
    """
    ...
    Args:
         ...
         force: Ignore all checks, use with caution
    """
    __api.log_command(sys._getframe().f_code.co_name, locals())
    try:
        # force must be passed as a keyword argument for wrapper to catch it.
        return __api.dae.set_simulation_mode(mode, force=force)
    except Exception as e:
        _handle_exception(e)
