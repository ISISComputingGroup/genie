...
def cget(block):
    ...
    try:
        ...
        block_pv = __api.get_pv_from_block(block)

        ans['name'] = block
        ans['value'] = __api.get_pv_value(block_pv) if ans['connected'] else None
        ans['runcontrol'], ans['lowlimit'], ans['highlimit'] = __api.get_runcontrol_settings(block_pv)
