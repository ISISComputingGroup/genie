...
if sys.version_info[0:3] != SUPPORTED_PYTHON_VERSION[0:3]:
    supported_version_str = "{[0]}.{[1]}.{2}".format(SUPPORTED_PYTHON_VERSION)
    current_version_str = "{[0]}.{[1]}.{2}".format(sys.version_info)
    message = "WARNING: genie_python only guarantees support for Python version {}, you are running {}"\
        .format(supported_version_str, current_version_str)
