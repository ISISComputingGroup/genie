...
@helparglist("...")
@log_command_and_handle_exception
def cset(*args: str, **kwargs: bool | int | float | str | None) -> None:
    """
    ...
    for block, value in list(zip(blocks, values)):
        ...
        # if wait is not passed in kwargs then it will be None,
        # but must take a default value of False

        if wait is None:
            wait = False

        assert isinstance(wait, bool), "Needs boolean argument for wait"
...
@log_command_and_handle_exception
def set_pv(
    name: str, value: bool | int | float | str | None, wait: bool = False, is_local: bool = False
) -> None:
    """
